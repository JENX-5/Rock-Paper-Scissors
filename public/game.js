class Game {
    constructor() {
        ...
        this.mode = this.params.get('mode') || 'cpu';
    ...
    hideChat() {
        // Hide chat panel completely in CPU mode
    ...
    updateTimerDisplay() {
        ...
        timerEl.innerHTML = `<i class="fas fa-clock"></i> ${timeText}`;
        
        // Warning color for last 5 seconds
        if (this.gameState.timer <= 5) {
            timerEl.classList.add('warning');
            timerEl.style.color = '#ff6b6b';
            timerEl.style.animation = 'warning-pulse 0.5s infinite';
        } else {
